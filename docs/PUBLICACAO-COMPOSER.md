...
- Tipo Composer: $type
- Descricao: Projeto base para APIs construidas com o framework Elavora.
- PHP: $php

## Instalacao

``bash
composer create-project elavora/api-skeleton nome-da-api
``
...
``text
https://github.com/Elavora/api-skeleton
``
